...
Controllers.renderAdminPage = (req, res) => {
	res.render('admin/plugins/talksimlish', {
		title: '[[themes/talksimlish:theme-name]]',
	});
};
...
Controllers.renderThemeSettings = async (req, res, next) => {
	...
	userData.title = '[[themes/talksimlish:settings.title]]';
	userData.breadcrumbs = helpers.buildBreadcrumbs([
		{ text: userData.username, url: `/user/${userData.userslug}` },
		{ text: '[[themes/talksimlish:settings.title]]' },
	]);
